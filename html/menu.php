...
<div class="navbar-default sidebar" role="navigation" style="overflow: visible;">
            <div class="slimScrollDiv" style="position: relative; overflow: visible; width: auto; height: 100%;"><div class="sidebar-nav slimscrollsidebar active" style="overflow-x: visible; overflow-y: hidden; width: auto; height: 100%;">
                <div class="sidebar-head">
                    <h3><span class="fa-fw open-close"><span class="glyphicon glyphicon-remove"></span></span> <span class="hide-menu">Navegação</span></h3> </div>
...
<!--                    <div class="dropdown user-pro-body">
                    ...
                    <ul class="nav in" id="side-menu">
                        <li class="active"> <a href="index.php" class="waves-effect"><span class="glyphicon glyphicon-globe"></span> <span class="hide-menu">  Home </span></a>
<!--                        <ul class="nav nav-second-level collapse in">
                            <li> <a href="index.html" class="active"><i class=" fa-fw">1</i><span class="hide-menu">Dashboard 1</span></a> </li>
...
<!--                    <li> <a href="relatorioClientes.php" class="waves-effect"><span class="glyphicon glyphicon-user"></span> <span class="hide-menu">Clientes </span> </span></a>
                        <ul class="nav nav-second-level collapse">
                            <li> <a href="clientes.php">Cadastrar </a> </li>
                            <li> <a href="relatorioClientes.php">Consultar </a> </li>
                        </ul>
                    </li>-->
                   
                    
<!--                    <li> <a href="funcionarios.php" class="waves-effect"><i class="fa fa-scissors" aria-hidden="true"></i> <span class="hide-menu">  Funcionários </span> </span></a>
                        <ul class="nav nav-second-level collapse">
...
<!--                    <li> <a href="controle-acesso.php" class="waves-effect"><span class="glyphicon glyphicon-lock"></span> <span class="hide-menu">  Controle de Acesso </span> </span></a>
                        <ul class="nav nav-second-level collapse">
                            <li> <a href="products.html"><i class="fa-fw">P</i><span class="hide-menu">Products</span></a> </li>
                            <li> <a href="product-orders.html"><i class="fa-fw">PO</i><span class="hide-menu">Product Orders</span></a> </li>
                            <li> <a href="product-details.html"><i class="fa-fw">PD</i><span class="hide-menu">Product Details</span></a> </li>
...
<!--                    <li> <a href="#" class="waves-effect"><i class="mdi mdi-format-color-fill fa-fw"></i> <span class="hide-menu">UI Elements<span class="fa arrow"></span> <span class="label label-rouded label-info pull-right">20</span> </span></a>
            ...
            </div><div class="slimScrollBar" style="background: rgba(0, 0, 0, 0.3); width: 6px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 686.401px;"></div><div class="slimScrollRail" style="width: 6px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
        </div>